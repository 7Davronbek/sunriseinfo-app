      ...
      >
        <SwiperSlide> <div className="img_carousel_1">
                        ...
                        <div className="btn_sotsh">
                            <button data-aos="fade-left" className="sena_send btn_sol">1 500 000 сум</button>
        ...
        <div className="img_carousel_1">
                        ...
                        <div className="btn_sotsh">
                            <button data-aos="fade-left" className="sena_send btn_sol">15 455 000 сум</button>
        ...
        <div className="img_carousel_1">
                        ...
                        <div className="btn_sotsh">
                            <button data-aos="fade-left" className="sena_send btn_sol">700 000 сум</button>
